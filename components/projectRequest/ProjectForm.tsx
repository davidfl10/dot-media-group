        ...
        <div className="flex w-full items-center justify-center p-10">
            {submittedData ? (
                ...
                <Step>
                    ...
                    <p className="font-jakarta text-[16px] text-neutral-400 text-center">Exploring services for {data.solution.replace(/-/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase())}</p>
                ...
                <Step>
                    ...
                    <p className="font-jakarta text-[16px] text-neutral-400 text-center">Refining your request for {data.service.replace(/-/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase())}</p>
