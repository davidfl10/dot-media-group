...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
    ...
    return (
        <div
            className={`sm-scope z-40 ${open ? 'h-screen' : 'h-24'} ${isFixed ? 'fixed top-0 left-0 w-screen overflow-hidden' : 'w-full h-full'}`}
        >
            <div
                className={
                    (className ? className + ' ' : '') + 'staggered-menu-wrapper pointer-events-auto relative w-full h-full z-40'
                }
            ...
            >
                ...
                <header
                    className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[2em] bg-transparent pointer-events-none z-20 rounded-[24px] bg-slate-800"
                    ...
                    <div className="sm-panel-frame">
                        ...
                        <div className="flex items-center justify-center gap-1">
                            <button className='flex items-center justify-center p-3 rounded-[44px] backdrop-blur-[6px] border-[1px] border-slate-200/20 bg-[linear-gradient(0deg,rgba(255,255,255,0.05)_0%,rgba(255,255,255,0.10)_100%)] hover:bg-slate-200/40 bg-[rgba(255, 255, 255, 0.15)] cursor-pointer backdrop-blur-md transition-colors'>
                                <span className='text-neutral-50 text-center font-jakarta text-xs leading-[18px] tracking-[1.2px] uppercase font-medium'>Start a project</span>
                            </button>
                            ...
                            >
                                {open ? (
                                    <Image src={Close} alt="Close menu" width={18} height={18} />
                                ) : (
                                    <Image src={Menu} alt="Open menu" width={18} height={18} />
                                )}
                            </button>
                        </div>
                    </div>
                ...
                <aside
                    ...
                    ref={panelRef}
                    className="staggered-menu-panel absolute top-0 right-0 h-full bg-[#0e0e0eb3] flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto"
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: #0e0e0eb3; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
.sm-scope [data-position='left'] .staggered-menu-panel { right: auto; left: 0; }
.sm-scope .sm-prelayers { position: absolute; top: 0; right: 0; bottom: 0; width: clamp(260px, 38vw, 420px); pointer-events: none; z-index: 5; }
.sm-scope [data-position='left'] .sm-prelayers { right: auto; left: 0; }
.sm-scope .sm-prelayer { position: absolute; top: 0; right: 0; height: 100%; width: 100%; transform: translateX(0); }
            .sm-scope .sm-panel-frame { display: flex; align-items: center; justify-content: space-between; padding: 8px; width: 100vw; }
            .sm-scope .sm-panel-inner { flex: 1; display: flex; flex-direction: column; gap: 1.25rem; }
            .sm-scope .sm-panel-frame { border: 1px solid #32323B; border-radius: 24px; background: rgba(14, 14, 14, 0.70); backdrop-filter: blur(24px); box-shadow: 0 4px 30px rgba(0,0,0,0.4); max-width: min(640px, 99%); width: 100%; }
...
.sm-scope .sm-panel-item { position: relative; color: #888888; font-weight: 500; font-size: 12px; cursor: pointer; line-height: 18px; letter-spacing: 1.2px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.4em; }
